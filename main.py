...
def show_user_details():
    ...
    label_nazwisko_szczegoly_obiketu_wartosc.config(text=nazwisko)
    label_lokalizacja_szczegoly_obiketu_wartosc.config(text=lokalizacja)
    label_liczba_postow_szczegoly_obiketu_wartosc.config(text=posty)
...
label_nazwisko_szczegoly_obiketu_wartosc = Label(ramka_szczegoly_obiektu, text="...")
label_liczba_postow_szczegoly_obiektu =Label(ramka_szczegoly_obiektu, text="Liczba postów: ")
label_liczba_postow_szczegoly_obiketu_wartosc = Label(ramka_szczegoly_obiektu, text="...")
label_lokalizacja_szczegoly_obiektu =Label(ramka_szczegoly_obiektu, text="Lokalizacja: ")
label_lokalizacja_szczegoly_obiketu_wartosc = Label(ramka_szczegoly_obiektu, text="...")
...
label_nazwisko_szczegoly_obiketu_wartosc.grid(row=1, column=3, sticky=W)
label_liczba_postow_szczegoly_obiektu.grid(row=1, column=4, sticky=W)
label_liczba_postow_szczegoly_obiketu_wartosc.grid(row=1, column=5, sticky=W)
